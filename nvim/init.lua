...
-- Centering screen on some movements
...
vim.keymap.set("n", "<leader>h", mark.add_file, { desc = "Add current file to [H]arpoon" })
...
-- [[ Configure Telescope ]]
-- Seeh`:help telescope` and `:help telescope.setup()`
